				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="post-content span11" style="<?php if($cc_post_options['cc_post_template_avatar'] == '1') { echo 'margin-left:0;'; } ?>">
							...
							<div class="entry">
							        <div class="cro-average-rating">Average rating will go here.<br /></div>
							    <div class="cro-info">
         ...
         print_r( $crochildren ); */
            if ( $crochildren ) {
                  foreach ( $crochildren as $crochild ) {
                        ...
                        <h4 class="review-title"><a href="<?php echo $childurl; ?>"><?php echo apply_filters( 'the_title' , $crochild->post_title );?></a></h4>
