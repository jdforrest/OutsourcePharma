...
//		add_action( 'bp_menu', array( $this, 'bp_menu' ), 2 );
			...
			<div id="search-bar" role="search">
				<div class="padder">
						...
						<form action="<?php echo bp_search_form_action() ?>" method="post" id="search-form">
							<input type="text" id="search-terms" name="search-terms" value="<?php echo isset( $_REQUEST['s'] ) ? esc_attr( $_REQUEST['s'] ) : ''; ?>" placeholder="<?php _e( 'Search', 'cc' ) ?>" />
	...
	function header_logo(){
		global $cap;
			...
			<div id="logo">
			<?php if($cap->logo){ ?>
			<a href="<?php echo home_url() ?>" title="<?php _e( 'Home', 'cc' ) ?>"><img src="<?php echo $cap->logo?>" alt="<?php bloginfo('description'); ?>" id="header-logo"></img></a>
			<?php } ?>
                        <div id="title-block">
			<h1><a href="<?php echo home_url() ?>" title="<?php _e( 'Home', 'cc' ) ?>" id="blog-title"><?php if(defined('BP_VERSION')){ bp_site_name(); } else { bloginfo('name'); } ?></a></h1>
		...
		<?php else: ?>
			...
			<?php } ?>
                        <div id="title-block">
			<h4><a href="<?php echo home_url() ?>" title="<?php _e( 'Home', 'cc' ) ?>" id="blog-title"><?php if(defined('BP_VERSION')){ bp_site_name(); } else { bloginfo('name'); } ?></a></h4>
			<div id="blog-description"><?php bloginfo('description'); ?></div>
                        </div>
			</div>
		<?php endif;
	...
	function footer_content(){
		...
		<?php if($cap->disable_credits_footer != false || !defined('is_pro')){ ?>
			<div class="credits">Copyright &copy; 2014. All Rights Reserved.</div>
		<?php } ?>
