...
/* > Header
--------------------------------------------------------------
Check to see if user can see the admin bar (from functions.php)
If so, then push header down 30px to make room.
-------------------------------------------------------------- */
...
/* .right-sidebar-padder {padding: 18px 9px 18px 9px}*/

/* .left-sidebar-padder {padding:18px 9px 18px 9px}
...
/* .paddersidebar{ padding: 18px 9px; } */
...
div.item-list-tabs ul li a span {
        background: none repeat scroll 0 0 #<?php echo $cap->bg_content_nav_color;?>;
...
a.comment-edit-link, a.comment-reply-link, a.button, ul.button-nav li a, div.generic-button a {
...
<?php if($cap->bg_body_color != "" && $cap->bg_body_color != __("transparent",'cc')){?>
    /** ***
    Adapting to body background color **/
...
<?php } ?>
 ...
 /*         // I can change my own widget width, thanks.
