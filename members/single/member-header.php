...
<div id="item-header-content">
	...
	<?php $membertitle=xprofile_get_field_data( 'Position/Title',bp_displayed_user_id());
	$membercompany=xprofile_get_field_data( 'Company',bp_displayed_user_id());
	echo $membertitle;
	if($membertitle!=='' && $membercompany!=='') {
		print(' at ');
	}
	echo $membercompany;
	 ?>
