	...
	$options = array(
		new Group (__("General",'cc'), "general",
			...
			new DropdownOption(
				...
				"title_font_style",
				array('OpenSans, Helvetica Neue, Helvetica, Arial, sans-serif', 'Helvetica Neue, Helvetica, Arial, sans-serif', 'Arial, sans-serif', 'Century Gothic, Avant Garde, Arial, sans-serif', 'Arial Black, Arial, sans-serif', 'Impact, Arial, sans-serif', 'Times New Roman, Times', 'Garamond, Times New Roman, Times'),
			...
			new DropdownOption(
				...
				"font_style",
				array('OpenSans, Helvetica Neue, Helvetica, Arial, sans-serif', 'Helvetica Neue, Helvetica, Arial, sans-serif', 'Arial, sans-serif', 'Century Gothic, Avant Garde, Arial, sans-serif', 'Times New Roman, Times', 'Garamond, Times New Roman, Times'),
				'Helvetica Neue, Helvetica, Arial, sans-serif',
				"start",
				__("Fonts",'cc')),
			new TextOption(
    ...
    //                                              ASC - Early posts at the top.",'cc'). '</span>',
		...
		new Group (__("Sidebars",'cc'), "sidebars",
			...
			new DropdownOption(
				...
				array('OpenSans, Helvetica Neue, Helvetica, Arial, sans-serif', 'Helvetica Neue, Helvetica, Arial, sans-serif', 'Arial, sans-serif', 'Impact, sans-serif', 'Century Gothic, Avant Garde, Arial, sans-serif', 'Times New Roman, Times', 'Garamond, Times New Roman, Times'),
				'Helvetica Neue, Helvetica, Arial, sans-serif',
				"start",
