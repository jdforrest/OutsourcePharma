...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	<head profile="http://gmpg.org/xfn/11">
		...
		<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); echo("?v1.6"); ?>" type="text/css" media="screen" />
     ...
     <div class="header-container">
        ...
        <div id="access">
    		<div class="menu">
				...
				<!-- BP menu --> <?php do_action('bp_menu') ?> <!-- BP menu -->

				<!-- Nav menu --> <?php /* Our navigation menu.  If one isn't filled out, wp_nav_menu falls back to wp_page_menu.  The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.  */ ?>
